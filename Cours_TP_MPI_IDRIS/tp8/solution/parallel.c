...
void voisinage() {
  ...
  voisin[N] = voisin[E] = voisin[W] = voisin[S] = MPI_PROC_NULL;
...
void ecrire_mpi(double *u) {
  ...
  int nb_octets_double,taille_type_sous_tab,taille_type_sous_tab_vue;
  ...
  /* Taille du type de base MPI_DOUBLE */
  MPI_Type_size(MPI_DOUBLE,&nb_octets_double);
  /* Taille  du type_derive type_sous_tab */
  MPI_Type_size(type_sous_tab,&taille_type_sous_tab);
  /* Taille du type_derive type_sous_tab_vue */
  MPI_Type_size(type_sous_tab_vue,&taille_type_sous_tab_vue);

  printf("Nombre elements de base %d Nombre elements vue %d pour le processus %d\n",
	 taille_type_sous_tab/nb_octets_double,
         taille_type_sous_tab_vue/nb_octets_double,
         rang);
